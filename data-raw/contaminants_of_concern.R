## code to prepare `contaminants_of_concern` dataset goes here
...
fwrite(final, file ="~/Desktop/contaminants_of_concern_geographies.csv")

usethis::use_data(contaminants_of_concern, overwrite = TRUE)
